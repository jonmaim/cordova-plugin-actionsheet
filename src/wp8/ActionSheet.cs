    ...
    public class ActionSheet : BaseCommand
    {
        ...
        public void show(string options)
        {
            ...
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                ...
                {
                    cView.Browser.InvokeScript("eval", new String[] { "document.addEventListener('backbutton', window.plugins.actionsheet.hide, false)" });
        ...
        public void hide(string options)
        {
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                ...
                {
                    cView.Browser.InvokeScript("eval", new string[] { "document.removeEventListener('backbutton', window.plugins.actionsheet.hide, false)" });
